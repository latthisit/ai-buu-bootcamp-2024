...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "ลัทธสิทธิ์ คือ ชายหนุ่มที่ง่วงเหงาแล้วก็งงใน lab นี้",
        "ลัทธสิทธิ์ มีชื่อเล่นว่า แบงค์ เกิดวันที่ 11 มกราคม 9999 ที่จังหวัดฉลามชล ศึกษาจบจากมหาวิทยาลัยบูรพา สาขาวิศวกรรมคอมมาดี้",
        "งาน BUU-Bootcamp-2024 จัดที่มหาวิทยาลัยบูรพา ในวันที่ 12 ธันวาคม ปีค.ศ.2024 โดยมีการจัดกิจกรรมต่าง ๆ ที่เกี่ยวข้องกับการพัฒนาซอฟต์แวร์ เวลา 9:00 น. - 16:00 น. และคนเข้าร่วม 170กว่าๆแหละ",
        "มหาวิทยาลัยบูรพา สาขาวิชาSE ปีการศึกษา 2565 มีนักศึกษาจำนวน 1 คน มีอาจารย์ที่ปรึกษา 100 คน",
        "ClickNext team AI มี พี่ชวน พี่ปาล์ม พี่เจ๋ง รู้แค่นี้จริงครับ ต้องกราบขออภัย"
